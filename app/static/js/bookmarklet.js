...
//    if (jQueryScript.src = "https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js", body.insertBefore(jQueryScript,body.firstChild), "undefined" == typeof d3) {
//        var d3Script = document.createElement("script");
//        d3Script.src = "https://d3js.org/d3.v3.min.js", body.insertBefore(d3Script,body.firstChild)
//    }
//} else if ("undefined" == typeof d3) {
//    var script = document.createElement("script");
//    script.src = "https://d3js.org/d3.v3.min.js", body.insertBefore(script,body.firstChild);
//}

if (void 0 === window.jQuery) {
    var jQueryScript = document.createElement("script");
    jQueryScript.setAttribute('async','false');
    jQueryScript.id='jQueryScript';
    jQueryScript.src='http://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js';
    body.insertBefore(jQueryScript,body.firstChild);
    if ("undefined" == typeof d3) {
        var d3Script = document.createElement("script");
        d3Script.setAttribute('async','false');
        d3Script.src = "https://d3js.org/d3.v3.min.js", body.insertBefore(d3Script,document.getElementById('jQueryScript'));
    }
} else if ("undefined" == typeof d3) {
    var d3Script = document.createElement("script");
    d3Script.src = "https://d3js.org/d3.v3.min.js", body.insertBefore(d3Script,body.firstChild);
...
var bookmarklet2 = document.createElement("script");
bookmarklet2.setAttribute('async','false');
bookmarklet2.src = "https://cdn.rawgit.com/lw453/fairshake/9110e63/bookmarklet2.js";
body.appendChild(bookmarklet2);
